...
// Custom Excerpts1
function html5wp_index_1($length) // Create 20 Word Callback for Index page Excerpts, call using html5wp_excerpt('html5wp_index');
{
    return 39;
}
...
function create_post_type_html5()
{
    ...
    register_post_type('html5-blank', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('HTML5', 'html5blank'), // Rename these to suit
...
\*------------------------------------*/
get_template_part('child/custom-function');
/**
